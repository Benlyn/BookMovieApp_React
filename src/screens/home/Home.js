...
class Home extends Component {
    ...
    componentWillMount = async () => {
        ...
        await fetch(this.props.baseUrl + "movies?status=PUBLISHED",
            ...
            .then(async response => {
                const moviePublishedData = await response.json();
                this.setState({ upcomingMovies: moviePublishedData.movies });
            });
        ...
        await fetch(this.props.baseUrl + "movies?status=RELEASED",
            ...
            .then(async response => {
                const movieReleasedData = await response.json();
                this.setState({ releasedMovies: movieReleasedData.movies });
            });
        ...
        await fetch(this.props.baseUrl + "genres",
            ...
            .then(async response => {
                ...
                this.setState({ genresList: genresData.genres });
            });


        /*Fetch the  Artists List*/
        await fetch(this.props.baseUrl + "artists",
            ...
            .then(async response => {
                ...
                this.setState({ artistsList: artistsData.artists });
            });
    }
